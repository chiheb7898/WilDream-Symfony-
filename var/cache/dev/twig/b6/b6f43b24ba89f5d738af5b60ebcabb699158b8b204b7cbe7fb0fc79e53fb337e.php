...
class __TwigTemplate_37dc4a5f8cc693f540bb4d610d4a6674b1087502f25b62a6291c96be06672570 extends Template
{
    private $source;
    private $macros = [];
    ...
    <thead class=\"trace-head\">
        ...
        echo (((0 === twig_compare(1, (isset($context["index"]) || array_key_exists("index", $context) ? $context["index"] : (function () { throw new RuntimeError('Variable "index" does not exist.', 4, $this->source); })())))) ? ("display") : (""));
        echo "\">
                <h3 class=\"trace-class\">
                    ";
        // line 6
        if ((1 === twig_compare((isset($context["num_exceptions"]) || array_key_exists("num_exceptions", $context) ? $context["num_exceptions"] : (function () { throw new RuntimeError('Variable "num_exceptions" does not exist.', 6, $this->source); })()), 1))) {
            // line 7
...
", "@Twig/Exception/traces_text.html.twig", "C:\\Users\\chihe\\Desktop\\PI\\New\\wildream\\vendor\\symfony\\twig-bundle\\Resources\\views\\Exception\\traces_text.html.twig");
    }
}
