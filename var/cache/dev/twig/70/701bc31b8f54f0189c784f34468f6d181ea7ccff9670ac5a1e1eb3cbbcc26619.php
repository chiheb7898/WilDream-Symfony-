...
class __TwigTemplate_79d30eaa7d251ec4a276ae3c08c66f8edae2dcb35b40bee1c3f341fb54894ffc extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 3
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new RuntimeError('Variable "status_code" does not exist.', 3, $this->source); })()), "js", null, true);
        echo " ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 3, $this->source); })()), "js", null, true);
        echo "
...
*/
", "@Twig/Exception/error.js.twig", "C:\\Users\\chihe\\Desktop\\PI\\New\\wildream\\vendor\\symfony\\twig-bundle\\Resources\\views\\Exception\\error.js.twig");
    }
}
