...
class __TwigTemplate_0043d1dfa58f4438cc723ddd0aa176fa02ba4674d7fc34cd47ec555e9c4e9789 extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("token", $context)) ? (_twig_default_filter((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 6, $this->source); })()), "")) : ("")), "latest"))) ? ("There are no profiles") : ("Token not found")), "message" => (((0 === twig_compare(((        // line 7
...
{% endblock %}
", "@WebProfiler/Profiler/info.html.twig", "C:\\Users\\chihe\\Desktop\\PI\\New\\wildream\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\info.html.twig");
    }
}
