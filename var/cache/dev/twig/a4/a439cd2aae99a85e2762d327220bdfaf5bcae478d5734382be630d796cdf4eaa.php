...
class __TwigTemplate_e930f16cf418d3ae66248c7359a7e1f2c0478eb1b026727c34240c9226dc6947 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 3
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new RuntimeError('Variable "status_code" does not exist.', 3, $this->source); })()), "css", null, true);
        echo " ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 3, $this->source); })()), "css", null, true);
        echo "
...
*/
", "@Twig/Exception/error.css.twig", "C:\\Users\\chihe\\Desktop\\PI\\New\\wildream\\vendor\\symfony\\twig-bundle\\Resources\\views\\Exception\\error.css.twig");
    }
}
