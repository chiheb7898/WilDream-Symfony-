...
class __TwigTemplate_6828e6c14ed5dbf968b060a2fd3f04bc67193e88588258e7447b3d93faba357e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"trace-details\">
        ...
        // line 11
        echo (((1 === twig_compare(twig_length_filter($this->env, twig_split_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 11, $this->source); })()), "class", [], "any", false, false, false, 11), "\\")), 1))) ? ("\\") : (""));
        echo "
                    </span>
                    ";
        // line 13
        ...
        echo "
                ...
                ";
        // line 16
        if (( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 16, $this->source); })()), "message", [], "any", false, false, false, 16)) && (1 === twig_compare((isset($context["index"]) || array_key_exists("index", $context) ? $context["index"] : (function () { throw new RuntimeError('Variable "index" does not exist.', 16, $this->source); })()), 1)))) {
            // line 17
...
", "@Twig/Exception/traces.html.twig", "C:\\Users\\chihe\\Desktop\\PI\\New\\wildream\\vendor\\symfony\\twig-bundle\\Resources\\views\\Exception\\traces.html.twig");
    }
}
