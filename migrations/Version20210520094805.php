 ...
 */
final class Version20210520094805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(255) NOT NULL, ADD fullname VARCHAR(255) NOT NULL, ADD is_active TINYINT(1) NOT NULL, DROP roles, DROP nom, DROP prenom, DROP phone, DROP adresse, DROP photos, DROP job, DROP pseudo, DROP localisation, DROP activation_token, DROP resert_token, CHANGE email email VARCHAR(255) NOT NULL');
    }
