 ...
 */
final class Version20210522142757 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE user_id user_id INT NOT NULL, CHANGE post_id post_id INT NOT NULL');
