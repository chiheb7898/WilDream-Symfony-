 ...
 */
final class Version20210522142520 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post INT NOT NULL, DROP post_id, CHANGE user_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id INT DEFAULT NULL, DROP post, CHANGE user_id user_id INT DEFAULT NULL');
